          ...
          {!isLoading && !isRefetching && user && (
            <>
              ...
              <div className="">
                <div className="md:not-sr-only sr-only">
                  <div className="relative group/cover ">
                    ...
                    <div className="avatar absolute -bottom-16 left-4">
                      <div className="md:w-32 w-24 rounded-full relative group/avatar">
                        <img
                          src={
                            profileImg ||
                            user?.profileImg ||
                ...
                <div className="relative group/cover not-sr-only md:sr-only">
                  <Link to="/">
                    <FaArrowLeft className="w-5 h-5 absolute left-2 top-2 text-white" />
                  </Link>
              ...
              <div className="flex flex-col gap-4 mt-14 px-4">
                <div className="flex flex-col">
                  ...
                  <span className="text-[15px] text-info-content my-1">
                    {user?.bio}
                  </span>
                </div>
